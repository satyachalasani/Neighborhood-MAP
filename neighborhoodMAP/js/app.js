...
var LocationMarker = function(data) {
    ...
    var clientID = 'X3S3YEK01AOA3PFAE5LTUZT0H13EOTGUYFYRF3GXMJCJ0J4H';
    var clientSecret = 'ND3AQTZ1A24FLNJ21OVBLHHBDKR4QZNJPSXWQCR5J3DVYLWO';

    // get JSON request of foursquare data
    var reqURL = 'https://api.foursquare.com/v2/venues/search?ll=' + this.position.lat + ',' + this.position.lng + '&client_id=' + clientID + '&client_secret=' + clientSecret + '&v=20170118' + '&query=' + this.title;

    $.getJSON(reqURL).done(function(data) {
		var results = data.response.venues[0];
        self.street = results.location.formattedAddress[0] || 'N/A';
        self.city = results.location.formattedAddress[1] || 'N/A';
        self.phone = results.contact.formattedPhone || 'N/A';
    }).fail(function() {
        alert('Something wrong with foursquare');
    });
